...
const demoData = {
  title: "Facilitating International Expertise in the United States",
  description: [
    "As a leading provider in the U.S., Joorney brings deep expertise in assisting companies with executive and specialized employee transfers from abroad. We collaborate closely with HR departments and work directly with the transferees to support their relocation.",
...
const imageWithText = {
  title: "Optimized for Cross-Border Employee Transfers",
  image: frameImage,
  steps: [
    {
...
export default function BusinessPlanL1() {
  return (
    <>
      <ServiceHeroSection
        title={"Business Plan for L-1 Intra company Transferee Visa"}
        subtitle={
          "“Under certain requirements, the L-1 Visa allows Canadian firms to move staff to U.S. offices. A comprehensive business plan is key to securing approval."
        }
        breadcrumb={{
          homeLabel: "Home",
          current: "Business Plan for L-1 Intra company Transferee Visa",
        }}
      />
